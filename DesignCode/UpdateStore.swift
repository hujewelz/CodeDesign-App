...
//  DesignCode
//
//  Created by luobobo on 2020/3/4.
...
let updateData = [
    ...
    Update(image: "Card5", title: "Framer Playground", text: "Create oiwerfyk animations add interactions with the Framer X code editor", date: "JUN 11"),
]
